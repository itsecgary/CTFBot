...
class CTF(commands.Cog):
    ...
    async def disband(self, ctx):
        ...
        try:
            ...
            existing_vchannel = discord.utils.find(ctx.guild.voice_channels, name=teamname, type=ctf.upper())
            existing_channel = discord.utils.find(ctx.guild.channels, name=teamname, type=ctf.upper())
