...
class CTF(commands.Cog):
    ...
    async def disband(self, ctx):
        ...
        try:
            ...
            existing_vchannel = discord.utils.get(ctx.guild.voice_channels, name=teamname, type=ctf.upper())
            existing_channel = discord.utils.get(ctx.guild.channels, name=teamname, type=ctf.upper())
